    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading">{{ trans('courses.new') . ' ' . trans('courses.course') }}</div>
                <div class="panel-body">
                    {{ Form::open(['method' => 'post', 'route' => 'supervisor.courses.store']) }}
                        ...
                        {{ link_to_route('supervisor.courses.index',
                            trans('courses.cancel'),
                            null,
